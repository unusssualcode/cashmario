...
while running:
    ...
    if gameplay:
        ...
        if bullets:
            for i, el in enumerate(bullets):
                ...
                if mushroom_list_in_game:
                    for index, mshrm in enumerate(mushroom_list_in_game):
                        if el.collidirect(mshrm):
                            mushroom_list_in_game.pop()
                            bullets.pop(i)
    ...
    for event in pygame.event.get():
        ...
        if (
            ...
            bullets.append(bullet.get_rect(topleft=(player_x + 100, player_y + 10)))
            bullets_left -= 1
